...
export class EmpleadoService {
  ...
  registrar( nombre: string, paterno: string, materno: string = '', sexo: boolean, fechaNacimiento: string, calle: string, exterior: string, interior: string = '', cp: string, colonia: string, telefono: string, correo: string, areas: string[], curp: string, salario: number ) : Observable<any> {
  ...
  modificar( uuid: string, nombre: string, paterno: string, materno: string = '', sexo: boolean, fechaNacimiento: string, calle: string, exterior: string, interior: string = '', cp: string, colonia: string, telefono: string, correo: string, areas: string[], curp: string, salario: number ) : Observable<any> {
